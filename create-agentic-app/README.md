# @websitelearners/create-saas-app
...
npx @websitelearners/create-saas-app@latest my-app -y -p pnpm

# Skip install and git init for faster scaffolding
npx @websitelearners/create-saas-app@latest my-app -y -p npm --skip-install --skip-git
```
...
```bash
cd /path/to/test-directory
npx @websitelearners/create-saas-app@latest test-project
# or use the specific version
npx @websitelearners/create-saas-app@1.1.4 test-project
```
...
- Verify actual registry: `npm view @websitelearners/create-saas-app version`
...
- Users may have cached versions. Tell them to:
  ```bash
  npx clear-npx-cache
  npx @websitelearners/create-saas-app@latest my-project
  # or use specific version
  npx @websitelearners/create-saas-app@1.1.4 my-project
  ```
